    ...
    routes: [{
        ...
        },
        {
            ...
            children: [{
                    ...
                    name: "personhome",
                    component: () =>
                        import ('./components/person/personhome')
                },
                {
                    path: "/myorder",
                    name: "myorder",
                    component: () =>
                        import ('./components/person/order/myorder'),
                ...
                },
                {
                    ...
                    name: "coupon",
                    component: () =>
                        import ("./components/person/wallet/coupon")
                },
                {
                    path: "/balance",
                    name: "balance",
                    component: () =>
                        import ('./components/person/wallet/balance')
                },
                {
                    path: "/paymethod",
                    name: "paymethod",
                    component: () =>
                        import ("./components/person/wallet/paymethod")
                },
                {
                    name: "addbank",
                    path: "/addbank",
                    component: () =>
                        import ("./components/person/wallet/addbank")
                },
                {
                    name: "myinfo",
                    path: "/myinfo",
                    component: () =>
                        import ("./components/person/myaccount/myinfo")
                },
                {
                    name: "changepassword",
                    path: "/changepassword",
        ...
        },
        {
            ...
            path: "/ordersubmit",
            component: () =>
                import ("./components/person/ordersubmit")
        },
        {
            redirect: "/",
            path: "/"
