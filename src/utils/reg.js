export default class reg {
    ...
    static checkname(rule, value, callback) {
            if (value === "") {
                callback("姓名不能为空")
                return false
            }
         ...
         * @param {*} callback 
         */
    static checkbankid(rule, value, callback) {
    ...
    static checkphonenumber(rule, value, callback) {
        if (value.length <= 0) {
            callback("手机号不能为空!")
            return false
        }
    ...
    static checkpassword(rule, value, callback) {
        if (value.length == 0) {
            callback("密码不能为空!");
            return false;
        }
    ...
    static checkspassword(rule, value, callback) {
        if (value.length <= 0) {
    ...
    static checkusername(rule, value, callback) {
        if (value.length == 0) {
            callback('昵称不能为空')
            return false
    ...
    static checkreg(rule, value, callback) {
        if (value.length == 0) {
            callback("验证码不能为空!")
            return false;
        }
